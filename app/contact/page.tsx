    ...
    return (
        <section className="text-white body-font relative bg-darkest">
            ...
            <div className="container px-5 py-12 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div className="lg:w-1/3 md:w-1/2 bg-gray-200 p-8 shadow-white shadow-2xl rounded-lg flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h2>
                    <p className="leading-relaxed mb-5 text-gray-600">Happy to connect!</p>
